...
public:
  ...
  void saveMutes(const uint8_t* data, size_t len);
  size_t loadMutes(uint8_t* data, size_t maxlen);
  void saveUnmutes(const uint8_t* data, size_t len);
  size_t loadUnmutes(uint8_t* data, size_t maxlen);
